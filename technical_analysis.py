...
ticker_name = "BTC-USD"
data = yf.download(f"{ticker_name}", period="6mo", interval="1d")
data.columns = ["Open", "High", "Low", "Close", "Adj_Close", "Volume"]
data_ta = add_all_ta_features(data, open="Open", high="High", low="Low", close="Adj_Close", volume="Volume")
data_ta.columns

"""
'Open', 'High', 'Low', 'Close', 'Adj_Close', 'Volume', 'volume_adi',
